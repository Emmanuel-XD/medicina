        ...
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-md-6">
                <div id="login-box" class="col-md-12">
                    ...
                    <br>
                    <p>Para poder generar tu cuenta de paciente primero debes completar algunos pasos. Rellena todos los campos</p>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <select name="rol" id="rol" class="form-control" disabled required>
