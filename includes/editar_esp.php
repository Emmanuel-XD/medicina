            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <h3 class="text-center">Editar registro de <?php echo $usuario ['especialidad']; ?></h3>
                            <br>
                            <div class="form-group">
                            <label for="nombre" class="form-label">Nombre de la Especialidad *</label>
                            <input type="text"  id="especialidad" name="especialidad" class="form-control" value="<?php echo $usuario ['especialidad']; ?>">
                            </div>
